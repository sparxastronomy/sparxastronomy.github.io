...
<Picture src="https://ik.imagekit.io/sparxastronomy/DEML71/DEML71_Spectra_CentralRegion.jpg"
...
Thus the model is in good agreement with the data. The values even though differs slightly from what was previously obtained the values obtained are within $3\sigma$ limit. Just to have an idea of how hot the plasma is, the obtained components translates back to $\approx 2.43, 8.54 \times {\rm 10^6~K}$. Its really very very hot!!       
